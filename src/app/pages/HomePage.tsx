      ...
      <div className="relative z-10 px-4 pt-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-pink-900">
                  Lo-fi Birthday Vibes
                </h3>
                <p className="text-xs text-pink-600">
                  Relaxing celebration music
                </p>
              </div>
            </div>
        ...
        >
          ...
          <p className="text-pink-800 leading-relaxed text-center mb-4">
            Today is all about celebrating the amazing person you are! Explore
            this interactive journey filled with memories, reasons why you're
            loved, and special surprises.
          </p>
          <p className="text-pink-700 text-center font-medium">
            Use the navigation below to explore everything we've prepared for
            you! 🎊
          </p>
        </motion.div>
      </div>
